(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        if (typeof options == 'string' ) {
            ...
            //默认配置项
            var settings = $.extend({
                placeholder:  ' ===Please Select=== ',//占位符，默认显示什么
                numDisplayed: 2,//设置页面上可以显示几个选项（超出这个数量将会显示选择了n项）
                overflowText: 'select {n} items',//超出这个数量将会显示"选择了n项"
                searchText: 'search',//搜索框中占位符显示什么字
        ...
        fSelect.prototype = {
            create: function() {
                ...
                //添加全选和清空按钮
                var BtnFixed = '<div class="btnFixed"><button class="buttonDefault" id="selectAllBtn" type="button">All</button><button class="buttonDefault" id="clearAllBtn" type="button">Clear</button></div>';
